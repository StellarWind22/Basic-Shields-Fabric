...
public class VanillaModule extends ContentModule {
    ...
    public void registerContent() {
        ...
        //Diamond
		diamond_shield = new ModItem("diamond_shield", new FabricBannerShieldItem(new FabricItemSettings().maxDamage(2098).group(BasicShields.SHIELDS), 90, 10, Items.DIAMOND));
