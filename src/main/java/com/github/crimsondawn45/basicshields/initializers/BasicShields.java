...
public class BasicShields implements ModInitializer {
	...
	public void onInitialize() {
		...
		amethyst =		new AmethystModule(     CONFIG.always_load_amethyst, 	"emerald_tools", "gemsandcrystals");
		...
		copper = 		new CopperModule(		CONFIG.always_load_copper, 		"gemsandcrystals");
		corundum = 		new CorundumModule(     CONFIG.always_load_corundum, 	"more_gems");
		emerald =		new EmeraldModule(		CONFIG.always_load_emerald, 	"emerald_tools", "gemsandcrystals");
