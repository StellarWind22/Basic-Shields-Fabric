...
public class BasicShieldItem extends Item implements FabricShield {
    ...
    private Identified<Item> repairTag;
    private Ingredient repairIngredients;
    private List<Identified<Item>> repairTags;
     ...
     */
    public BasicShieldItem(Settings settings, int cooldownTicks, int enchantability, Item... repairItems) {
        super(settings);
     ...
     */
    public BasicShieldItem(Settings settings, int cooldownTicks, int enchantability, Identified<Item> repairItemTag) {
        super(settings);
     ...
     */
    public BasicShieldItem(Settings settings, int cooldownTicks, ToolMaterial material) {
     ...
     * @param repairItemTag item tag for repair shield.
     */
    public BasicShieldItem(Settings settings, int cooldownTicks, int enchantability, List<Identified<Item>> repairItemTags) {
        super(settings);
    ...
    public boolean canRepair(ItemStack stack, ItemStack ingredient) {
        switch(this.repairType) {
            ...
            case TAG_ARRAY:
                for(Identified<Item> tag : this.repairTags) {
