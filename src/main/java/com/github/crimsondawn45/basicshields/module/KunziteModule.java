...
public class KunziteModule extends ContentModule {
    ...
    public void registerContent() {
        ...
        //Tag
        kunzite_tag = TagKey.of(RegistryKeys.ITEM, new Identifier("c", "kunzite"));

        //Item
        kunzite_shield = new ModShieldItem(this,"kunzite_shield",
        new FabricBannerShieldItem(new FabricItemSettings().maxDamage(BasicShields.CONFIG.kunzite_shield_durability),
